import { BaseHttpClient } from './../http/base-http-client.interface';
import { Injectable } from '@angular/core';
import { HttpClient } from '@angular/common/http';

@Injectable()
export abstract class BaseService implements BaseHttpClient {
  ...
  protected addHeaders(options: any, headers: object): object {
    if (!options) {
      options = { headers: {} };
    }
